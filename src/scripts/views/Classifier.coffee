define (require, exports, module) ->
  module.exports = """
    <div class="world-tour-banner">
        <h2>This audio clip was recorded in New Zealand. <a href="http://blog.batdetective.org/2016/05/04/bat-detective-new-zealand-world-tour/" target="_blank">Click here</a> to learn more about New Zealand bats and the Bat Detective World Tour.</h2>
    </div>
    <div class="interface">
