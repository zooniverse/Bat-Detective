define (require, exports, module) ->
  module.exports = """
    <div class="world-tour-banner">
        <h2>This audio clip was recorded in Zambia. <a href="http://blog.batdetective.org/2016/01/04/zambia-kasanka-world-tour-bat-detective-information/" target="_blank">Click here</a> to learn more about Zambian bats and the Bat Detective World Tour.</h2>
    </div>
    <div class="interface">
